...
const GameBody = () => {
  ...
  return (
    ...
    >
      <Grid>
        <FeaturedGame
          svgLogo={`${process.env.PUBLIC_URL}/assets/game-logos/wordy-verse-logo-name.svg`}
          description="A collection of ultra-niche word puzzles. Track your streak, compete on leaderboards and play with friends!"
          title="Wordy-verse"
          link="/wordy-verse"
          bgColor="#ffd583"
        />
